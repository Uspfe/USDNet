...
from trainer.trainer import InstanceSegmentation, RegularCheckpointing, EpochSettingCallback
...
def get_parameters(cfg: DictConfig):
    ...
    if cfg.general.interaction_backbone_checkpoint is not None:
        cfg, model = load_interaction_backbone_from_checkpoint(cfg, model)
