...
# training the movalbe part segmentation and articulation prediction model
...
general.experiment_name="train_mov_articulation" \
...
data.cropping=true \
data.crop_length=5.5 \
data.crop_min_size=75000 \
